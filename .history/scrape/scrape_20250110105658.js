...
(async () => {
    try {
        ...
        // Step 4: Randomize and group jobs by scrape date
        const randomizedJobs = groupAndRandomizeJobsByDate(finalJobList);
        console.log(`Randomized jobs by scrape date. Ready to write to CSV.`);

        // Step 5: Write the final job list to the CSV
        await writeToCsv(randomizedJobs);
