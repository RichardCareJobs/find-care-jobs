...
async function loadExistingJobs() {
    console.log("Loading existing jobs from CSV...");
    const existingJobs = [];
...
async function updateJobListings(newJobListings) {
    ...
    console.log(`Mapped ${Object.keys(existingJobsMap).length} existing jobs.`);
    ...
    console.log(`Writing ${finalJobList.length} jobs to CSV...`);
